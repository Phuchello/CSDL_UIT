...
- [x] D2 — build the production-candidate Quartz garden on `v1.1-quartz-garden` from frozen D1, with pinned upstream, provenance-labelled notes, local search, semantic graph/backlinks, fixture/PDF contracts, responsive checks, and fresh visual captures (`reports/v1.1_quartz_d2_qa.md`).
- [ ] D2 human mentor review and decision on whether to merge the candidate.
- [ ] Merge to `main`.
