...
## Active Queue — v1.2 Learning System Design Synchronization (`v1.2-learning-system-design`, PR #5)
- [x] Draft design architecture on `v1.2-learning-system-design` (PR #5)
