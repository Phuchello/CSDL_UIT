...
- Cover A — Editorial Schema: warm paper field, navy/teal relation boxes, a diagonal CUSTOMER → ORDER → ORDER_DETAIL → PRODUCT chain, and a quiet PK/FK key. Recommended default for discussion only; the reviewer chooses.
- Cover B — Formal Relational: a denser mathematical composition with R, π, ⋈, ÷, key underlines, and a compact relation grid.
- Cover C — Minimal Structural: large type, a single vertical relation spine, sparse key marks, and the strongest negative space.
...
|---|---|---:|---|
| Cover title | Arial, Segoe UI, sans-serif | 30–35 pt | uppercase, 700–800, generous tracking |
| Part/chapter title | Arial, Segoe UI, sans-serif | 22–25 pt / 1.12 | 700, navy |
| H2 | Arial, Segoe UI, sans-serif | 15 pt / 1.2 | 700, teal rule |
| H3 | Arial, Segoe UI, sans-serif | 11.5 pt / 1.25 | 700, ink |
| Body | Georgia, Cambria, serif | 10.5 pt / 1.48 | regular, 62–72 character measure |
| Caption/table | Arial, Segoe UI, sans-serif | 8.5–9 pt / 1.3 | muted ink |
