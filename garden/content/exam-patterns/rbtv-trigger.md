...
Trong các đề thi Tự luận Cuối kỳ và Thực hành máy UIT (minh chứng qua `EXAM-2024-2025-HK1-FINAL-01`, `PRAC-2023-2024-HK1-FINAL-01` và slide bài giảng `LOC-LEC-LONG-CH05`), dạng bài Ràng buộc toàn vẹn (RBTV) và Trigger luôn xuất hiện với cấu trúc chặt chẽ:
...
3. **Lựa chọn cơ chế thực thi**: Phân định rạch ròi giữa ràng buộc khai báo nội tại (`CHECK`, `PRIMARY KEY`, `FOREIGN KEY`) và ràng buộc phức tạp liên quan hệ bắt buộc phải dùng `TRIGGER`.
